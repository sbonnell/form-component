...
const columns: ColumnConfig[] = [
  ...
  { key: "email", label: "Email", type: "text", truncate: 100 },
...
const userFormSchema = drizzleTableToFormSchema(users, "users");
...
export default function UsersPage() {
  ...
  const loadData = async (page: number) => {
    try {
      ...
      const response = await fetch(
        `/demo/crud/api/users?page=${page}&pageSize=${pageSize}`
      );
  ...
  const handleDelete = async (record: User) => {
    if (!confirm(`Are you sure you want to delete user "${record.name}"? This action cannot be undone.`)) {
      return;
    }
    ...
    try {
      ...
      const response = await fetch("/demo/crud/api/users", {
        method: "DELETE",
        ...
        <div className="bg-white rounded-lg border p-6 mb-6">
          ...
          <CrudForm
            ...
            onSuccess={() => {
              ...
              loadData(1); // Reload first page after creation
            }}
        ...
        <div className="bg-white rounded-lg border p-6 mb-6">
          ...
          <CrudForm
            ...
            onSuccess={() => {
              ...
              loadData(currentPage); // Reload current page after update
            }}
