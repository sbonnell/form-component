          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              <div className="flex">
                <Link 
                  href="/" 
                  className="flex items-center px-2 py-2 text-gray-900 font-bold text-lg hover:text-blue-600 transition-colors"
                >
                  📋 Schema-Driven Forms
                </Link>
              ...
              <div className="flex items-center">
                <a
                  href="https://github.com/sbonnell/form-component"
                  target="_blank"
